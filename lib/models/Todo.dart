...
class Todo extends amplify_core.Model {
  ...
  const Todo._internal({required this.id, required name, description, required completed, dueDate, createdAt, updatedAt}): _name = name, _description = description, _completed = completed, _dueDate = dueDate, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todo({String? id, required String name, String? description, required bool completed, amplify_core.TemporalDate? dueDate}) {
  ...
  Todo copyWith({String? name, String? description, bool? completed, amplify_core.TemporalDate? dueDate}) {
    return Todo._internal(
      id: id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'description': _description, 'completed': _completed, 'dueDate': _dueDate?.format(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
